...
/** Mismo patrón que ExerciseRowMenu, para los bloques de una rutina de natación. */
export function SwimBlockRowMenu({
  label,
  moveUp,
  moveDown,
  remove,
  ...
  return (
    <>
      <button
        ...
        aria-label={t.natacion.menuBloque.opciones(label)}
        ...
        >
          ...
          >
            ...
            <div className="mb-4 flex items-center justify-between gap-3">
              <p className="min-w-0 truncate text-[17px] font-semibold">{label}</p>
              <button
                type="button"
                onClick={() => setOpen(false)}
            ...
            <div className="group-list overflow-hidden rounded-card bg-surface">
              <form action={moveUp}>
                ...
                >
                  <ArrowUp className="h-5 w-5 text-muted" /> {t.natacion.menuBloque.subir}
                </button>
              </form>
              <form action={moveDown}>
                <button
                  ...
                  className="flex w-full items-center gap-3 p-4 text-left text-[17px] disabled:opacity-30"
                >
                  <ArrowDown className="h-5 w-5 text-muted" /> {t.natacion.menuBloque.bajar}
                </button>
              </form>
              <form action={remove}>
                <button
                ...
                >
                  <Trash2 className="h-5 w-5" /> {t.natacion.menuBloque.quitar}
                </button>
              </form>
            </div>
          </div>
